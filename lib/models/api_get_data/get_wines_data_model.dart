...
//
//     final getWinesDataModel = getWinesDataModelFromJson(jsonString);

import 'dart:convert';

List<GetWinesDataModel> getWinesDataModelFromJson(String str) => List<GetWinesDataModel>.from(json.decode(str).map((x) => GetWinesDataModel.fromJson(x)));

String getWinesDataModelToJson(List<GetWinesDataModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class GetWinesDataModel {
  ...
  factory GetWinesDataModel.fromJson(Map<String, dynamic> json) => GetWinesDataModel(
